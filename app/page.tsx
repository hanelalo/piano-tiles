...
export default function Home() {
  ...
  return (
    ...
    <main className="flex w-full h-screen justify-center items-stretch overflow-hidden">
      ...
      <div className="flex-1 w-full max-w-[500px] lg:max-w-[768px] min-w-[320px] h-screen flex flex-col relative z-10 bg-gradient-to-br from-[#667eea] to-[#764ba2] shadow-[0_0_50px_rgba(0,0,0,0.5)] md:ring-1 md:ring-white/10">
        {/* Header */}
        <header className="text-center text-white pt-3 pb-2 shrink-0 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <h1 className="text-2xl md:text-3xl lg:text-4xl font-black mb-1 drop-shadow-[0_2px_10px_rgba(0,0,0,0.9)] text-white">
              🎹 Piano Tiles
            </h1>
            <p className="text-sm md:text-base lg:text-lg font-semibold opacity-95 drop-shadow-[0_1px_5px_rgba(0,0,0,0.7)] text-white">
